...
export default function EditProfileModal({
  ...
  const handleSave = async () => {
    ...
    setError("");
    try {
      const { data } = await api.patch("/user/profile", { username, bio, image });
      onUpdate(data);
      onClose();
    } catch {
    ...
    >
      ...
      ">
        ...
        <div className="flex items-center justify-between">
          <div>
            <h2 className="font-display text-[24px] font-semibold text-[#1c1917] tracking-wide">
              Edit Profile
            </h2>
            <p className="text-[12px] text-[#a08070] mt-0.5">
        ...
        <div className="flex flex-col items-center gap-3">
          <div className="relative group">
            ...
            ">
              <svg
                viewBox="0 0 24 24" fill="none" stroke="white" strokeWidth="1.8"
          ...
          <div className="flex flex-col gap-1.5">
            ...
            <div className="relative">
              ...
              <input
                ...
                className="
                  glass-input pl-8
                  focus:border-[rgba(201,150,122,0.44)] focus:bg-[rgba(255,253,249,0.88)]
                "
              />
            </div>
          </div>
        ...
        <div className="flex items-center gap-3 pt-1">
          <button
            ...
            className="
              ...
              border border-[rgba(201,150,122,0.22)] text-[#a08070]
              hover:bg-[rgba(201,150,122,0.06)] transition-all duration-200
            "
          >
            Cancel
          </button>
